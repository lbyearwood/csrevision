...
| 9 | SingleMultipleChoiceCard | accepted | Complete clickable A-D question with thick borders, green tick/red cross states and reset control. |
...
| 5 | MultipleChoiceOption | accepted | Reusable component file used by multiple-choice card examples. |
