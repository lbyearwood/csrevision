...
function ensureLessonToolAssets() {
  const stylesheets = [
    lessonAssetUrl("assets/css/lesson-shell.css?v=18"),
    lessonAssetUrl("assets/css/lesson-components.css?v=188"),
    lessonAssetUrl("assets/css/lesson-slide-footer.css?v=19"),
    lessonAssetUrl("assets/css/lesson-left-panel.css?v=7"),
