...
- Migration history has been verified through the current local migration set after reset/reseed.
...
- Keep the bulk QA seed deterministic and rerunnable when new staged-test fixtures are added.
