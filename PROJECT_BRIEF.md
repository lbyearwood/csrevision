...
**Codex audience note:** Future agents should treat this as product constraints and decision history. Follow `Planning/Process/CODEX_START_PROCESS.md` first, then read `Planning/Process/PROJECT_TASKS.md` for live state.

---

## Change Log

This section records material project direction changes, architecture decisions, and major feature-scope changes. Routine implementation progress belongs in `Planning/Process/PROJECT_TASKS.md`; exact file history belongs in Git.
...
| 2026-07-25 | 0.2 | Added `Planning/Process/PROJECT_TASKS.md` as the active running task tracker. | Separate day-to-day delivery tracking from the long-term project brief. |
...
| 2026-08-01 | 0.6 | Confirmed that student-submitted code will never be executed; programming formats use fixed code, approved choices, blanks, debugging, output prediction, ordering, or explicit accepted complete variants. | Avoid an unnecessary code-execution service and keep marking deterministic within TypeScript and Supabase. |
| 2026-08-01 | 0.6 | Confirmed curriculum questions and revision content are generated and validated by Codex before deployment, not generated by the live application. | Keep the production system focused on accounts, published content, assignments, attempts, answers and results without live AI-generation infrastructure. |

## Change Control Process

- Update this Change Log for material scope, architecture, security, data model, deployment, or feature-direction changes.
- Update `Planning/Process/PROJECT_TASKS.md` for day-to-day work, status, blockers, and next actions.
...
- `Planning/Setup/SUPABASE_SETUP.md`.
- `Planning/Architecture/DATA_MODEL.md`.
- `Planning/Architecture/RLS_POLICIES.md`.
- `Planning/Architecture/SEED_CONTENT_FORMAT.md`.
- `Planning/Setup/DEPLOYMENT_GITHUB_PAGES.md`.
- `Planning/Architecture/AI_MARKING.md`.
- `Planning/Architecture/SECURITY.md`.
- `.env.example`.
