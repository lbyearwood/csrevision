...
questionBanks["1-1-1"] = {
  ...
  questions: [
    ...
    { question: "<strong>Discuss</strong> how different parts of the CPU are involved in processing instructions. In your answer, refer to the ALU, Control Unit, cache and registers.", marks: 8, markSchemeIntro: "Award up to 8 marks:", markScheme: ["The CPU processes instructions using the fetch-execute cycle.", "The Control Unit coordinates the fetch-execute cycle.", "The Control Unit decodes instructions.", "The Control Unit sends control signals to other CPU components.", "The ALU performs arithmetic operations.", "The ALU performs logical/comparison operations.", "Cache stores frequently used data and instructions.", "Cache allows the CPU to access data/instructions faster than main memory.", "Registers temporarily store data, instructions or addresses currently being used.", "The MAR stores the address of a memory location.", "The MDR stores data being transferred to or from memory.", "The Program Counter stores the address of the next instruction.", "The Accumulator stores results from calculations.", "A developed answer links these components together during fetching, decoding and executing.", "Accept any other valid point."] }
  ]
};
