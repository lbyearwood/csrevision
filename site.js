    ...
    "groups": [
      ...
      },
      {
        ...
        "topics": [
          {
            "id": "1-2-1",
            "title": "1.2.1 Primary storage"
          },
          {
            "id": "1-2-2",
            "title": "1.2.2 Virtual memory"
          },
          {
            "id": "1-2-3",
            "title": "1.2.3 Secondary storage"
          },
          {
            "id": "1-2-4",
            "title": "1.2.4 Binary units"
          },
          {
            "id": "1-2-5",
            "title": "1.2.5 Binary number system"
          },
          {
            "id": "1-2-6",
            "title": "1.2.6 Hexadecimal number system"
          },
          {
            "id": "1-2-7",
            "title": "1.2.7 Binary addition and binary shifts"
          },
          {
            "id": "1-2-8",
            "title": "1.2.8 Characters"
          },
          {
            "id": "1-2-9",
            "title": "1.2.9 Images"
      ...
      },
      {
        ...
        "topics": [
          {
            "id": "1-3-1",
            "title": "1.3.1 LAN vs WAN"
          },
          {
            "id": "1-3-2",
            "title": "1.3.2 Star vs Mesh topologies"
          },
          {
            "id": "1-3-3",
            "title": "1.3.3 Client-server vs Peer-to-peer architectures"
          },
          {
            "id": "1-3-4",
            "title": "1.3.4 Network hardware"
          },
          {
            "id": "1-3-5",
            "title": "1.3.5 The Internet, DNS and Cloud"
          },
          {
            "id": "1-3-6",
            "title": "1.3.6 Wired vs Wireless networks and performance factors"
          },
          {
            "id": "1-3-7",
            "title": "1.3.7 Network protocols"
          },
          {
            "id": "1-3-8",
            "title": "1.3.8 Network layers"
          },
          {
            "id": "1-3-9",
            "title": "1.3.9 Encryption"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "topics": [
          {
            "id": "1-6-1-1",
            "title": "1.6.1.1 Ethical, legal, cultural, environmental and privacy issues"
          },
          {
            "id": "1-6-1-2",
            "title": "1.6.1.2 Legislation"
          },
          {
            "id": "1-6-1-3",
            "title": "1.6.1.3 Software licences"
          }
        ]
      }
    ]
    ...
    "groups": [
      {
        ...
        "topics": [
          {
            "id": "2-1-1",
            "title": "2.1.1 Abstraction"
          },
          {
            "id": "2-1-2",
            "title": "2.1.2 Decomposition"
          },
          {
            "id": "2-1-3",
            "title": "2.1.3 Algorithmic thinking"
          },
          {
            "id": "2-1-4",
            "title": "2.1.4 Structure diagrams"
          },
          {
            "id": "2-1-5",
            "title": "2.1.5 Pseudocode"
          },
          {
            "id": "2-1-6",
            "title": "2.1.6 Flowcharts"
          },
          {
            "id": "2-1-7",
            "title": "2.1.7 Identifying common errors"
          },
          {
            "id": "2-1-8",
            "title": "2.1.8 Searching algorithms"
          },
          {
            "id": "2-1-9",
            "title": "2.1.9 Sorting algorithms"
          },
          {
            "id": "2-1-10",
            "title": "2.1.10 Trace tables"
          }
        ]
      },
      {
        ...
        "topics": [
          ...
          {
            "id": "2-2-3",
            "title": "2.2.3 String manipulation"
          },
          {
            "id": "2-2-4",
            "title": "2.2.4 File handling"
          },
          {
            "id": "2-2-5",
            "title": "2.2.5 Records"
          ...
          {
            "id": "2-2-7",
            "title": "2.2.7 Lists / Arrays"
          },
          {
            "id": "2-2-8",
            "title": "2.2.8 Sub programs"
          },
          {
            "id": "2-2-9",
            "title": "2.2.9 Random number generation"
          }
        ]
      },
      {
        ...
        "topics": [
          ...
          {
            "id": "2-3-2",
            "title": "2.3.2 Testing & identifying errors"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "topics": [
          {
            "id": "2-6-1",
            "title": "2.6.1 Writing basic programs"
          },
          {
            "id": "2-6-2",
            "title": "2.6.2 Writing advanced programs"
          }
        ]
      }
    ]
    ...
    paperGroup.groups.forEach((group) => {
      ...
      group.topics.forEach((topic) => {
        ...
        if (availableQuizIds.has(topic.id)) {
          ...
          quizLink.className = "action-button quiz-button";
          quizLink.href = quizSlug(topic.id);
          quizLink.textContent = "Quiz";
          quizLink.setAttribute("aria-label", `${topic.title} self-marking quiz`);
          actions.appendChild(quizLink);
        } else {
          const quizButton = document.createElement("button");
          quizButton.className = "action-button quiz-button";
          quizButton.type = "button";
          quizButton.textContent = "Quiz";
          quizButton.disabled = true;
          quizButton.title = "Self-marking quiz coming soon.";
          quizButton.setAttribute("aria-label", `${topic.title} self-marking quiz coming soon`);
...
function setupMarkSchemeButtons() {
...
function highlightAlgorithmCode() {
  ...
  const tokenPattern = new RegExp(
    `(".*?"|'.*?'|#.*$|\\b(?:TRUE|FALSE|True|False)\\b|\\b(?:${keywordPattern})\\b|\\b\\d+(?:\\.\\d+)?\\b|==|!=|<=|>=|[+\\-*/=<>]|\\b[A-Za-z_][A-Za-z0-9_]*(?=\\())`,
    "gm"
  );
  ...
  document.querySelectorAll(".algorithm-code code").forEach((codeBlock) => {
    ...
    while (match) {
      ...
      } else if (/^(TRUE|FALSE|True|False)$/.test(token)) {
